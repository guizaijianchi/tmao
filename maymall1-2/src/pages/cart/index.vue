  ...
  <div>
    ...
    <div class="total">
      <div class="cart-no-good" :class="hasProduct?'isHidden':''">
        <div class="opps">
          <img src="~@/assets/images/icon/pay_pop_img_loading_fail.png" alt>
        </div>
    ...
    export default {
            data(){
                return {
                    ...
                    totalPrice: 0,
                    totalQuantity: 0,
                    checkNotIcon: require("@/assets/images/icon/order_not_checked.png"),
                    checkIcon: require("@/assets/images/icon/order_checked.png"),
                    chooseAll: false,
                    cartLists: []
                };
            },
       ...
       computed: {
        ...
        methods:{
            carts(){
                this.cartLists = storage.getItem("cart") ? JSON.parse(storage.getItem("cart")) : [];
...
.pay-btn .min-btn {
  ...
  font-size: 18px;
  display: inline-block;
  background: url("~@/assets/images/icon/cartReduce.png") no-repeat;
...
.pay-btn .max-btn {
  ...
  font-size: 18px;
  display: inline-block;
  background: url("~@/assets/images/icon/cartAdd.png") no-repeat;
  background-size: 100% 100%;
}
